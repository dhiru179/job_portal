                ...
                if (data.length > 0) {
                    ...
                    data.forEach((elem, index) => {
                        ...
                        if (tagType == 'input') {
                            ...
                            if (type == "radio" || type == "checkbox") {
                                ...
                                options.forEach((e, i) => {
                                    if (elem.id === e.tmp_tbl_form_field_id) {
                                        ...
                                        option += `<div class="form-check form-check-inline">
                                                    ...
                                                    <input class="form-check-input" name="${name}" type="${type}" id="inlineCheckbox${i}" value="${e.option}">
                                ...
                                if (type == "checkbox" && a < 2) {
                                    ...
                                    option = `<div class="form-check form-check-inline">
                                            ...
                                            <input class="form-check-input singleCheckField" name="${elem.name}" type="${type}"  id="inlineCheckbox${index}" value="${singleCheck.check.option}">
                                ...
                                formHtml += `<div class="mb-3">
                                                ...
                                                <input type="${type}" id="${elem.name}" name="${elem.name}"  class="form-control" value="" >
                                            </div>`;
                            }
                            ...
                            options.forEach((e, i) => {
                                if (elem.id === e.tmp_tbl_form_field_id) {
                                    option += `<option value="${e.option}">${e.option}</option>`;
                                }
                            })
                            ...
                            formHtml += `<div class="mb-3">
                                        ...
                                        <label for=""  class="form-label">${elem.label+star}</label>
                                        <select  name="${elem.name}" id="${elem.name}" class="form-select">
                                            ${option}
                                         </select>   
                                     </div>`;
                            ...
                            formHtml += `<div class="mb-3">
                                        ...
                                        <label for="" class="form-label">${elem.label+star}</label>
                                        <textarea name="${elem.name}" id="${elem.name}" cols="3" rows="2" class="form-control"></textarea>
                                    </div>`;
                        }
        ...
        $('#save').click((e) => {
            ...
            if (validate.is_validate === false) {
               ...
               let a=0;
                ...
                //     if(String(value.name).includes('[]'))
                //     {
                //         form[value.name].options[a] = value.value;
                //         a++;
                //     }
